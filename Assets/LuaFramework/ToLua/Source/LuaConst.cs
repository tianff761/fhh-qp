...
{
    public static string luaDir = Application.dataPath + "/LuaFramework/ToLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/LuaFramework/ToLua/Lua";        //tolua lua文件目录

    /// <summary>
    /// Lua核心代码AB包名称
    /// </summary>
    public static string LuaCoreAssetBundleName = "luacore";
    /// <summary>
    /// AB包模块前缀，文件名称有该前缀，表示需要解析后面文件夹名称作为AB包的名称，且不能使用该前缀作为文件夹
    /// </summary>
    public const string LuaBundleModulePrefix = "AB/";
