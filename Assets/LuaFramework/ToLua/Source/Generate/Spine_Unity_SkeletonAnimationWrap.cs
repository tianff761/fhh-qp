	...
	static int AddToGameObject(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				...
				Spine.Unity.SkeletonAnimation o = Spine.Unity.SkeletonAnimation.AddToGameObject(arg0, arg1, arg2);
				ToLua.Push(L, o);
				return 1;
			}
			else
	...
	static int NewSkeletonAnimationGameObject(IntPtr L)
	{
		try
		{
			...
			else if (count == 2)
			{
				...
				Spine.Unity.SkeletonAnimation o = Spine.Unity.SkeletonAnimation.NewSkeletonAnimationGameObject(arg0, arg1);
				ToLua.Push(L, o);
				return 1;
			}
			else
