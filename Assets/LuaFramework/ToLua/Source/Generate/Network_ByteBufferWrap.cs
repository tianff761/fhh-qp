...
public class Network_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Network.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateNetwork_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateNetwork_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Network.ByteBuffer obj = new Network.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				Network.ByteBuffer obj = new Network.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Network.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			Network.ByteBuffer obj = (Network.ByteBuffer)ToLua.CheckObject<Network.ByteBuffer>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
