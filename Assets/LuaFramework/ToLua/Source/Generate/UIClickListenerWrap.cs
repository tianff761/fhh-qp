...
public class UIClickListenerWrap
{
	...
	static int OnPointerClick(IntPtr L)
	{
		try
		{
			...
			UIClickListener obj = (UIClickListener)ToLua.CheckObject<UIClickListener>(L, 1);
	...
	static int get_onClick(IntPtr L)
	{
		...
		try
		{
			...
			System.Action<UIClickListener> ret = obj.onClick;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_onClick(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIClickListener obj = (UIClickListener)o;
			System.Action<UIClickListener> arg0 = (System.Action<UIClickListener>)ToLua.CheckDelegate<System.Action<UIClickListener>>(L, 2);
			obj.onClick = arg0;
			return 0;
		}
		catch(Exception e)
