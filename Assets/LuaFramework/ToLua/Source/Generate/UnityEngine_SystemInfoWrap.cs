...
public class UnityEngine_SystemInfoWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("minConstantBufferOffsetAlignment", get_minConstantBufferOffsetAlignment, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_minConstantBufferOffsetAlignment(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.SystemInfo.minConstantBufferOffsetAlignment);
			return 1;
		}
		catch (Exception e)
		{
