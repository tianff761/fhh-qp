...
/// 血战到底资源打包
/// </summary>
public class Pin5Packager : MonoBehaviour
{
    /// <summary>
    /// 资源名称
    /// </summary>
    private const string RES_NAME = "Pin5";

    [MenuItem("Build Resources/" + RES_NAME + "/Build", false, 1301)]
    ...
    [MenuItem("Build Resources/" + RES_NAME + "/Mark", false, 1302)]
    ...
    public static List<AssetBundleBuild> GetBuildConfigs(bool isMark)
    {
        ...
        //游戏特效图片
        configDatas.Add(AssetbundleConfigData.New(resFolderName + "/pin5gameeff", resFolderPath + "Effects/", "*.png", SearchOption.AllDirectories));

        //房间资源
        configDatas.Add(AssetbundleConfigData.New(resFolderName + "/pin5room", resFolderPath + "Atlas/Pin5Room", "*.png"));
        //设置界面
        configDatas.Add(AssetbundleConfigData.New(resFolderName + "/pin5room", resFolderPath + "Atlas/Pin5Setting/", "*.png"));
        ...
        //搓牌
        configDatas.Add(AssetbundleConfigData.New(resFolderName + "/rubcard", resFolderPath + "Textures/Pin5RubCard", "*.png"));
