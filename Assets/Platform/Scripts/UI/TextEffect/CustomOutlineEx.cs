...
/// UGUI描边
/// </summary>
public class CustomOutlineEx : BaseMeshEffect
{
    /// <summary>
    /// 材质球路径
    /// </summary>
    private static string MAT_PATH = "Assets/Platform/Resources/Shader/OutlineMat.mat";
    /// <summary>
    /// Shader的完整名称
    /// </summary>
    private static string SHADER_NAME = "TSF Shaders/UI/OutlineEx";
    ...
    protected override void Start()
    {
        ...
        if (base.graphic)
        {
            if (base.graphic.material == null || base.graphic.material.shader.name != SHADER_NAME)
            {
#if UNITY_EDITOR

                var texMaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>(MAT_PATH);
                if (texMaterial != null)
                {
    ...
    protected override void OnValidate()
    {
        ...
        {
            if (base.graphic.material.shader.name != SHADER_NAME)
            {
                var texMaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>(MAT_PATH);
                if (texMaterial != null)
                {
