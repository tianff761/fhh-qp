...
{
    private const string OutLineShaderName = "UI/TextShader";
    ...
    private void UpdateOutLineMaterial()
    {
        ...
        if (!Application.isPlaying)
        {
            if (base.graphic && base.graphic.material == base.graphic.defaultMaterial)
            {
                base.graphic.material = UnityEditor.AssetDatabase.LoadAssetAtPath<Material>("Assets/Application/Resources/Shader/TextEffect/TextShader.mat");
            }
        }
        else
        {
