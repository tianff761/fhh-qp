...
public abstract class UITweener : MonoBehaviour
{
    ...
    /// 完成回调
    /// </summary>
    public Action<UITweener> onFinished = null;
    /// <summary>
    /// LUA回调方法
    /// </summary>
    ...
    public void AddLuaFinished(LuaFunction luaFunction)
    {
    ...
    void Update()
    {
        ...
        if ((style == Style.Once) && (duration == 0f || mFactor > 1f || mFactor < 0f))
        {
            ...
            {
                this.mLuaFunction.Call(this.gameObject);
            }
        }
    ...
    void SetResetToBeginning() { ResetToBeginning(); }
}
