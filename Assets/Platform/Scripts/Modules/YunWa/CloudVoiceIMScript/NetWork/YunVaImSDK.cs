...
namespace YunvaIM
{
  ...
  //      }
        ...
        public void ChatRobotRequest(int targetType)
        {
            uint parser = YunVaImInterface.instance.YVpacket_get_parser();
            YunVaImInterface.instance.YVparser_set_integer(parser, 1, targetType);
            YunVaImInterface.instance.YV_SendCmd(CmdChannel.IM_TOOLS, (uint)ProtocolEnum.IM_CHAT_ROBOT_OPEN_REQ, parser);
        }
    }
}
